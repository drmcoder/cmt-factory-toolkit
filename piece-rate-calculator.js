...
// Machine complexity bonus (% of base pay)
...
// Quality threshold by machine type (penalty if score below)
...
function calculatePieceRate({
  ...
  if (qualityScore < threshold) {
    const deficit = threshold - qualityScore;
    qualityPenalty = base * (deficit / 100);
  }
...
module.exports = { calculatePieceRate, SKILL_MULTIPLIERS, MACHINE_COMPLEXITY_BONUS, QUALITY_THRESHOLD };
